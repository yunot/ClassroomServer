        ...
        <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
            ...
            <div class="nav-wrapper">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="${pageContext.request.contextPath}/admin/CourseManagement">
            ...
            <div class="main-content-container container-fluid px-4">
                ...
                <div class="page-header row no-gutters py-4">
                    <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                        ...
                        <span class="text-uppercase page-subtitle">Course Management</span>
                    </div>
                </div>
                <!-- End Page Header -->
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="card card-small mb-4">
                                ...
                                <button id="addMainBtn" type="button" class="btn btn-primary" onclick="addMain()">添加主要课程</button>
                            </div>
                        </div>
                        <!-- end Main Course -->
                        <!-- Other Course -->
                        <div class="col-12 col-md-6">
                            <div class="card card-small mb-4">
                                ...
                                <button id="addOtherBtn" type="button" class="btn btn-primary" onclick="addOther()">添加其他课程</button>
                            </div>
                        </div>
                        <!-- end Other Course -->
                    </div>
...
<!-- Edit Course View  -->
<div class="modal fade" tabindex="-1" role="dialog" id="CourseView">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-4"><h6 class="text-primary">课程名称</h6></div>
                        <div class="col-md-8"><input class="form-control" id="CourseName" placeholder="课程名称"></div>
                        <div class="col-md-12"><br></div>
                    </div>
                    <div class="row">
                        <div class="col-md-4"><h6 class="text-primary">课程编号</h6></div>
                        <div class="col-md-8"><input class="form-control" id="CourseId" placeholder="课程编号"></div>
                        <div class="col-md-12"><br></div>
                    </div>
                    <div class="row">
                        <div class="col-md-4"><h6 class="text-primary">学时</h6></div>
                        <div class="col-md-8"><input class="form-control" id="CourseTime" placeholder="学时"></div>
                        <div class="col-md-12"><br></div>
                    </div>
                    <div class="row">
                        <div class="col-md-4"><h6 class="text-primary">开课周</h6></div>
                        <div class="col-md-8"><input class="form-control" id="StartWeek" placeholder="开课周(eg. 5-18)"></div>
                        <div class="col-md-12"><br></div>
                    </div>
                    <div class="row">
                        <div class="col-md-4"><h6 class="text-primary">无课周</h6></div>
                        <div class="col-md-8"><input class="form-control" id="StopWeek" placeholder="无课周(eg. 9,13)"></div>
                        <div class="col-md-12"><br></div>
                    </div>
                </div>
            </div>
...
<script>
    window.onload = function(){
        ...
        tableShow(mainBody, '${mainCourse}');
        tableShow(otherBody, '${otherCourse}');
    }
...
<script src="${pageContext.request.contextPath}/views/admin/scripts/course-management.js" type="text/javascript" charset="utf-8"></script>
</body>
</html>

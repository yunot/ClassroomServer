        ...
        <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
            ...
            <div class="nav-wrapper">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="${pageContext.request.contextPath}/admin/ReportRepairs">
                    ...
                    <div class="row pt-1">
                        <div class="col-lg-6">
                            <div class="row">
                                ...
                                <div class="col-lg-12"><textarea id="DamageInfo" class="form-control" rows="2" readonly></textarea></div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="row">
                                <div class="col-lg-12"><h6 class="text-primary">备注</h6> </div>
                                <div class="col-lg-12"><textarea id="Remark" class="form-control" rows="2" readonly></textarea></div>
                            </div>
                        </div>

        ...
        <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
            ...
            <div class="nav-wrapper">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="${pageContext.request.contextPath}/admin/CheckingIn">
            ...
            <div class="main-content-container container-fluid px-4">
                ...
                <div class="page-header row no-gutters py-4">
                    <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                        <h3 class="page-title">考勤信息</h3>
                        <span class="text-uppercase page-subtitle">Checking In Information</span>
                    </div>
                </div>
                <!-- End Page Header -->
                <div class="card card-small mb-4">
                    <div class="card-header">
                        <div class="row"><div class="col-4"><h6>考勤列表</h6></div> </div>
                    </div>
                    <div class="card-body p-0 pb-3 text-center">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">学生考勤</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">教师考勤</a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <div class="studentContent" style="height: 60%; width: 100%; overflow: auto;">
                                    <table id="studentTable" class="table table-sm table-hover stu-thead-sticky nowrap">
                                        <thead>
                                            <tr>
                                                <th>周次</th>
                                                <th>课程</th>
                            ...
                            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                <div class="teacherContent" style="height: 60%; width: 100%; overflow: auto;">
                                    <table id="teacherTable" class="table table-sm table-hover tea-thead-sticky nowrap">
                                        <thead>
                                            <tr>
                                                <th>周次</th>
                                                <th>课程</th>
...
<script src="${pageContext.request.contextPath}/views/admin/scripts/checking-in.js" type="text/javascript" charset="utf-8"></script>

<script type="text/javascript">
    window.onload = function(){
        showAttendanceInfo('${stuInfo}', '${teaInfo}');
    }
</script>
</body>
</html>

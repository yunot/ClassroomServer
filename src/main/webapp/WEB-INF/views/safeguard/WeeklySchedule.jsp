        ...
        <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
            ...
            <div class="nav-wrapper">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="${pageContext.request.contextPath}/safeguard/WeeklySchedule">
            ...
            <div class="main-content-container container-fluid px-4">
                ...
                <div class="page-header row no-gutters py-4">
                    <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                        ...
                        <span class="text-uppercase page-subtitle">Weekly schedule information</span>
                    </div>
                </div>
                <!-- End Page Header -->
                <!-- Info Card -->
...
<script src="${pageContext.request.contextPath}/views/student/scripts/weekly-schedule.js" type="text/javascript" charset="utf-8"></script>

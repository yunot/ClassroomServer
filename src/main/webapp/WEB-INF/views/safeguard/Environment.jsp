        ...
        <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
            ...
            <div class="nav-wrapper">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link" href="${pageContext.request.contextPath}/safeguard/ReportRepairs">
                            <span class="mdi mdi-18px mdi-hammer"></span> 设备报修
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="${pageContext.request.contextPath}/safeguard/Environment">
                                ...
                                <div class="card card-small p-3 mb-4">
                                    <div class="row">
                                        <div class="col-6 col-sm-6">
                                            <div><h5 id="envWater" class="mdi mdi-24px mdi-water text-primary"></h5></div>
                                            <div><h5 id="envPower" class="mdi mdi-24px mdi-power-plug text-danger"></h5></div>
                                            <div><h5 id="envVTD" class="mdi mdi-24px mdi-emoticon-devil text-secondary"></h5></div>
                                            <div><h5 id="frontDoor" class="mdi mdi-24px mdi-door text-success"></h5></div>
                                            <div><h5 id="backDoor" class="mdi mdi-24px mdi-door text-success"></h5></div>
                                        </div>
                                        <div class="col-6 col-sm-6">
                                            <div><h5 id="envWin1" class="mdi mdi-24px mdi-view-compact-outline text-info"></h5></div>
                                            <div><h5 id="envWin2" class="mdi mdi-24px mdi-view-compact-outline text-info"></h5></div>
                                            <div><h5 id="envWin3" class="mdi mdi-24px mdi-view-compact-outline text-info"></h5></div>
                                            <div><h5 id="envWin4" class="mdi mdi-24px mdi-view-compact-outline text-info"></h5></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card card-small mb-3"  style="position: sticky; top: 80px;">
                            <div class="card-header bg-primary text-center">
                                <div class="row" style="height: 1rem;">
                                    <div class="col-12">
                                        <p class="font-weight-bold text-white"><span class="mdi mdi-home"></span> 实验室</p>
                                    </div>
                                </div>
                            </div>

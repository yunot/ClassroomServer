...
<div class="layui-carousel" id="test3" lay-filter="test4">
    <div carousel-item>
        <div style="background-color:white">
            <span class="h4 d-block font-weight-normal mb-2">倒计时<i class="icon icon-clock"></i></span>
            <span class="font-weight-light">离...还有...天</span></div>
        <div style="background-color:green">条目2</div>
        <div style="background-color:red">条目3</div>
...
<div class="layui-carousel" id="test10">
    <div carousel-item="card-body">
        <div><img src="${pageContext.request.contextPath}/views/admin/newresource/imgs/avatar-1.png"></div>
        <div><h4>通知</h4>
        </div>
    </div>
</div>
...
<script src="${pageContext.request.contextPath}/views/admin/newresource//layui/layui.js" charset="utf-8"></script>
